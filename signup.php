...
<body class="text-center">
  ...
  <main class="form-signin">
    <form action="/auth.php" method="POST">
      <img class="mb-4" src="assets/brand/Farm.png" alt="" width="170" height="170">
      ...
      <div class="form-floating">
        <input type="text" name="phoneNumber" class="form-control" id="floatingInput" placeholder="Phone Number">
      ...
      <div class="form-floating">
        <input type="text" name="pincode" class="form-control" id="floatingInput" placeholder="Pin Code">
